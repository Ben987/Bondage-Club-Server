...
function AccountDifficulty(data, socket) {
	if ((data != null) && (typeof data === "number") && (data >= 0) && (data <= 3)) {
		...
		const LastChange = ((Acc.Difficulty == null) || (Acc.Difficulty.LastChange == null) || (typeof Acc.Difficulty.LastChange !== "number")) ? Acc.Creation : Acc.Difficulty.LastChange;
		if ((data <= 1) || (LastChange + DifficultyDelay < CommonTime())) {
			// Updates the account and the database
			const NewDifficulty = { Difficulty: { Level: /** @type {DifficultyLevel} */ (data), LastChange: CommonTime() } };
